% This script compares the linear regression, stepwise regression and principal least squares (PLS) regression methods for the depended variables FG and GR.
