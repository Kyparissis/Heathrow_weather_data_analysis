% This script finds the best non-linear (up to 3rd degree) regression model for every pair of indicators.
% The best model is the one with the maximum adjusted R2 value.
