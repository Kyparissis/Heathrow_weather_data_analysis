% This function calculates the parametric and bootstrap hypothesis testing for the mean difference between two samples.
% The parametric hypothesis testing is based on the t(Student)-statistic and the bootstrap hypothesis testing is based on the resampling method.
% INPUTS:
% years: A vector of the years.
% indicatorSample: A vector of the indicator sample.
% OUTPUTS:
% p_parametric: The p-value for the hypothesis test H0: mu1 = mu2 using the t(Student)-statistic parametric test.
% p_bootstrap: The p-value for the hypothesis test H0: mu1 = mu2 using the resampling method bootstrap test.
function [p_parametric, p_bootstrap] = parametricTestSignificantMeanDifference(years, indicatorSample)
