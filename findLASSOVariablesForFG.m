% This script finds the optimal model for the depended variable FG and GR using LASSO regression method.
...
[OptimalModel_bin, LASSO_PenaltyFactor] = LASSORegression(dependedVariable, independedVariables);
