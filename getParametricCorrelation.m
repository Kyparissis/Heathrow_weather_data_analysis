% This function calculates the Pearson's correlation coefficient and the mutual information between two samples.
% The Pearson's correlation coefficient is calculated using the Fisher Transform and the bootstrap method.
% The p-value is calculated using the t(Student)-statistic parametric test and the randomization method non-parametric test.
% INPUTS:
% sample1: A vector of the first sample.
% sample2: A vector of the second sample.
% OUTPUTS:
% paramFisherCI: The 95% confidence interval for the correlation coefficient using the Fisher Transform.
% bstrpCI: The 95% confidence interval for the correlation coefficient using the bootstrap method.
% p_param: The p-value for the hypothesis test H0: r=0 using the t(Student)-statistic parametric test.
% p_nonParam: The p-value for the hypothesis test H0: r=0 using the randomization method non-parametric test.
% n: The number of the samples.
function [paramFisherCI, bstrpCI, p_param, p_nonParam, n] = getParametricCorrelation(sample1, sample2)
