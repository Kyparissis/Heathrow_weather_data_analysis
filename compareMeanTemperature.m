% This script calculates the mean value of every indicator in the period 1949-1958 and 
% then calculates the 95% parametric and bootstrap confidence intervals for the mean value of 
% every indicator in the period 1973-after.
...
for i = 1:9   % Checking for the first 9 indicators
    [parametricCI(i, :), bstrpCI(i, :)] = computeConfidenceIntervals(HeathrowINDICATORData_after1973(:, i));
